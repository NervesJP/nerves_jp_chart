defmodule NervesJpChartWeb.ChartHumidityLive do
  ...
  def handle_info(:next_values, socket) do
    ...
    values =
      users
      |> Enum.map(&NervesJpChart.Measurements.last_by_user(&1, 1))
    ...
    values =
      ...
      |> Enum.map(& &1.value)
      |> Enum.map(fn value -> if value > 100, do: 100, else: value end)
  ...
  def render(assigns) do
    ...
    # Elixir
    json = Jason.encode!(%{value: %{name: "nervesjp", value: 40.123, time: 1605097502}})
